...
export default function Descriptor() {
  return (
    <div className={`${s.descriptor} container-fluid`}>
      ...
      {" "}
        ...
        <p className={s.description}>
          Меня зовут Сергей Артемов, я занимаюсь разработкой и поддержкой
          сайтов. Создаю дизайн, верстаю и программирую.
        </p>
      </div>
      ...
      <div className={`${s.blob} ${s.blobSecond}`}>
        <Image className={s.blobImage} src={blobFirstImage} alt="blob second image" />
      </div>
      <div className={`${s.blob} ${s.blobThird}`}>+</div>
