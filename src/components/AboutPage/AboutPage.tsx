      ...
      <div className={`${s.aboutTextWrapper} block-mb`}>
        ...
        <div className={s.aboutBlock}>
          ...
          <p className={s.description}>
            👋 Меня зовут Сергей Артемов, я frontend-разработчик и фрилансер. Разрабатываю то, что браузер выводит на экран.
            ...
            Мне нравится использовать React.js или Next.js для создания сайтов и функциональных веб-приложений. Также работаю с 1СБитрикс, Wordpress и Tilda.
          </p>
          <p className={s.description}>
